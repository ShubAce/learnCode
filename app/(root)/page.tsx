import { Code2, Trophy, Users, Zap, ChevronRight, Play, Star, Moon, Sun, Menu } from "lucide-react";
		...
		<div className="min-h-screen  transition-colors mt-24">
				...
				<div className="max-w-6xl mx-auto text-center">
					...
					<h1 className="text-2xl md:text-5xl lg:text-6xl font-black text-gray-900 dark:text-white leading-tight mb-8">
						...
						<span className="relative inline-block">
							<span className="px-6 py-3 bg-amber-500 dark:bg-amber-400 text-white dark:text-gray-900 rounded-2xl transform inline-block shadow-lg -rotate-5 ">
								Problem
							</span>
						</span>{" "}
						Solving
						...
						with{" "}
						<span className="relative inline-block">
							<span className="px-6 py-3 bg-indigo-600 dark:bg-indigo-500 text-white rounded-2xl transform rotate-4 inline-block shadow-lg">
								Code
							</span>
						</span>
					</h1>
					...
					<p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-12 leading-relaxed">
						Challenge yourself with thousands of coding problems, compete with developers worldwide, and accelerate your programming
						journey with real-time feedback and expert solutions.
					</p>
				...
				<div className="max-w-6xl mx-auto px-4">
					<div className="text-center mb-16">
						<h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
							Everything you need to <span className="text-amber-600 dark:text-amber-400">excel</span>
						</h2>
						...
						{features.map((feature, index) => (
							...
							>
								<CardHeader>
									<div
										className={`w-12 h-12 ${
											index % 2 === 0 ? "bg-amber-100 dark:bg-amber-900" : "bg-indigo-100 dark:bg-indigo-900"
										} rounded-xl flex items-center justify-center ${
											index % 2 === 0 ? "text-amber-600 dark:text-amber-400" : "text-indigo-600 dark:text-indigo-400"
										} mb-4`}
									>
										{feature.icon}
									</div>
			...
			>
				<div className="max-w-6xl mx-auto px-4">
					<div className="text-center mb-16">
						<h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
							Choose your <span className="text-indigo-600 dark:text-indigo-400">challenge</span>
						</h2>
						<p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
								...
								<CardContent className="space-y-4">
									...
									<div
										className={`font-semibold ${
											category.color === "amber" ? "text-amber-600 dark:text-amber-400" : "text-indigo-600 dark:text-indigo-400"
										}`}
									>
										{category.count}
									</div>
			...
			<section className="py-24 bg-gradient-to-r from-amber-600 to-amber-300  dark:from-amber-600 dark:to-indigo-600 rounded-md">
				<div className="max-w-4xl mx-auto text-center px-4">
					<h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Ready to start your coding journey?</h2>
					<p className="text-xl text-white/90 mb-8">Join thousands of developers who are improving their skills every day</p>
					<Button
						size="lg"
